...
@FeignClient(url = "http://localhost:9192", name = "bank-statement")
public interface BankDocumentMngrAPIClient {
  ...
  List<BankStatementDetailDTO> getBankStatementDetailsByDate(@PathVariable(value = "date") @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate date);
